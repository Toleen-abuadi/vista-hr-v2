...
const endRecordImage = document.querySelector('img#end-record-image');
const audio = new Audio("VISTA-BOT.mp3");
...
function stopRecording() {
    mediaRecorder.stop();
    stopCamera();
    document.getElementById("end-record-image").style.display = "inline";
}
